...
# Description:
"""
Django settings for ExpenseSubmitSystem project.
...
WSGI_APPLICATION = 'ExpenseSubmitSystem.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'debug_static'),
]
